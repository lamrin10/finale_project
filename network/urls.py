...
from .views import  BookscollView,RecommendView
...
urlpatterns = [
    ...
    path('n/bookscoll/', BookscollView.as_view(), name='bookscoll'),
    path('n/recommend/', RecommendView.as_view(), name='recommend'),
    path('n/search/', views.search_view, name='search'),
